...
import br.com.wassistemas.tasko.produto.adapter.out.persistence.mapper.ProdutoEstoqueLocalizacaoEntityMapper;
import br.com.wassistemas.tasko.produto.adapter.out.persistence.repository.ProdutoEstoqueLocalizacaoRepository;
import br.com.wassistemas.tasko.produto.application.port.out.produtoestoque.AdicionarProdutoEstoqueLocalizacaoPort;
import br.com.wassistemas.tasko.produto.application.port.out.produtoestoque.AtualizarProdutoEstoqueLocalizacaoPort;
import br.com.wassistemas.tasko.produto.application.port.out.produtoestoque.ExcluirProdutoEstoqueLocalizacaoPorIdPort;
import br.com.wassistemas.tasko.produto.application.port.out.produtoestoque.ListarProdutoEstoqueLocalizacaoPort;
import br.com.wassistemas.tasko.produto.application.port.out.produtoestoque.ObterProdutoEstoqueLocalizacaoPorIdPort;
...
public class ProdutoEstoqueLocalizacaoPersistenceAdapter implements
    AdicionarProdutoEstoqueLocalizacaoPort, AtualizarProdutoEstoqueLocalizacaoPort,
    ExcluirProdutoEstoqueLocalizacaoPorIdPort, ListarProdutoEstoqueLocalizacaoPort,
    ObterProdutoEstoqueLocalizacaoPorIdPort {
