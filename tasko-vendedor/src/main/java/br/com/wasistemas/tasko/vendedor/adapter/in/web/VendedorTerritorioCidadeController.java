...
import br.com.wasistemas.tasko.vendedor.adapter.in.web.mapper.VendedorTerritorioCidadeWebMapper;
import br.com.wasistemas.tasko.vendedor.adapter.in.web.request.AdicionarVendedorTerritorioCidadeRequest;
...
public class VendedorTerritorioCidadeController {
    ...
    public GeneralApiResponse<VendedorTerritorioCidade> adicionar(@PathVariable Long territorioId,
        ...
        return GeneralApiResponse.<VendedorTerritorioCidade>builder()
                ...
                .data(vendedorTerritorioCidadeUseCases.adicionar(vendedorTerritorioCidadeWebMapper.toDomain(request)))
                .build();
    }
