...
import br.com.wassistemas.tasko.produto.adapter.in.web.mapper.ProdutoPrecoWebMapper;
import br.com.wassistemas.tasko.produto.adapter.in.web.request.AdicionarProdutoPrecoRequest;
import br.com.wassistemas.tasko.produto.application.port.in.usecases.ProdutoPrecoUseCases;
...
public class ProdutoPrecoController {
  ...
  public GeneralApiResponse<ProdutoPreco> adicionar(
      @RequestBody AdicionarProdutoPrecoRequest request) throws ResourceDuplicateException {
