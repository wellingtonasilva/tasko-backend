...
import br.com.wasistemas.tasko.pedido.adapter.out.persistence.mapper.FormaPagamentoEntityMapper;
import br.com.wasistemas.tasko.pedido.adapter.out.persistence.repository.FormaPagamentoRepository;
...
public class FormaPagamentoPersistenceAdapter implements AdicionarFormaPagamentoPort, AtualizarFormaPagamentoPort,
    ...
    @Override
    public List<FormaPagamento> listarFormaPagamento(Paginacao paginacao) {
