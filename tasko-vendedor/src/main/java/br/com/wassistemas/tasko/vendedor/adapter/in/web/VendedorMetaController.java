...
public class VendedorMetaController {
  ...
  public GeneralApiResponse<VendedorMeta> adicionar(
      @RequestBody AdicionarVendedorMetaRequest request) throws ResourceDuplicateException {
  ...
  public GeneralApiResponse<List<VendedorMeta>> listarVendedor(
