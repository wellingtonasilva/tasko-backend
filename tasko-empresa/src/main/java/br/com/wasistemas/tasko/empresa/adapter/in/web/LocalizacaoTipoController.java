...
import br.com.wasistemas.tasko.empresa.adapter.in.web.mapper.LocalizacaoTipoWebMapper;
...
public class LocalizacaoTipoController {
    ...
    public GeneralApiResponse<LocalizacaoTipo> adicionar(@RequestBody AdicionarLocalizacaoTipoRequest request) {
